...
import { uploadUserTags } from 'common/api/auth';
...
export const UsersUploadForm = ({ id, onCancel, onDone, isEmployee, employeeId }) => {
    

    const { form, submit, loading, } = useHandleForm({
        create: (data) => uploadUserTags(employeeId, data),
        // edit: editRelocation,
        // retrieve: retrieveRelocation,
        success: 'User created/edited successfully',
        failure: 'Error in creating/editing Upload User .',
        done: onDone,
        close: onCancel,
        id,
