...
import { uploadEndOfLife } from 'common/api/auth';
...
export const EndOfLifeUploadForm = ({ id, onCancel, onDone, isEmployee }) => {



    const { form, submit, loading } = useHandleForm({
        create: uploadEndOfLife,
        // edit: editRelocation,
    ...
    return (
        <Spin spinning={loading}>
            <Divider orientation="left"> Discarded Tags</Divider>
            <Form
                onFinish={preProcess}
                form={form}
